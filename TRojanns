...
-- made by d00mshack niggas.. --
-- dont change cuz this small code below only works on dahood looool --

if game.PlaceId == 2788229376 then

getgenv().Enabled = true
getgenv().Aimlockkey = "q"
getgenv().Prediction = 0.11529944883
getgenv().Aimpart = "HumanoidRootPart"
getgenv().Notifications = true
getgenv().Colorr = Color3.fromRGB(242, 243, 243)
getgenv().FOV = true
getgenv().Notifications = true
getgenv().Colorr = Color3.fromRGB(242, 243, 243)
...
local Settings = {
    ...
    Settings = {
        Thickness = 3.5,
        Transparency = 1,
        Colorr = Color3.fromRGB(242, 243, 243),
        FOV = false
    }
